...
%
% NOTE BEFORE SUBMITTING: arXiv requires a real author name and an
% institutional or verifiable affiliation. Replace the placeholder below.
...
\author{zcashsensei\thanks{Correspondence via
\url{https://github.com/zcashsensei/heartwood}. Reference implementation,
receipts, and all evaluation artefacts are MIT-licensed and public.}}
...
A verifier performs seven checks, all offline:

\begin{enumerate}\itemsep2pt
\item regenerate the pool from the seed and confirm the commitment;
\item re-derive the beacon-bound order and confirm it matches the transcript
prefix (this single check defeats cherry-picking, reordering, and beacon
